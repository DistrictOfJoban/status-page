...
const Home: NextPage = () => {
  return (
    <div className='h-full w-full '>
      ...
      <div className="w-full h-40 absolute bg-gradient-to-t from-sky-800 to-sky-600 dark:from-sky-900 dark:to-sky-700">
        <div className="sm:ml-0 ml-5 mr-0 mt-3 md:pl-80 md:pr-80 sm:w-full h-full">
          <Image src="/doj.svg" width={380} height={100} className="w-40 h-16" alt="Tailwind Play" />
        </div>
      </div>
      <div className='mt-20 w-full absolute overflow-auto'>
        <ServicesSection />
      </div >
    </div>
  )
